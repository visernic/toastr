...
class Toastr
{
    ...
    {
        return '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/visernic/toastr@' . $version . '/dist/css/visernic-toastr.min.css">';
    }
    ...
    {
        return '<script src="https://cdn.jsdelivr.net/gh/visernic/toastr@' . $version . '/dist/js/visernic-toastr.min.js"></script>';
    }
