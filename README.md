# Visernic Toastr for Laravel

Visernic Toastr is a Laravel package that provides an easy way to display toast notifications in your Laravel applications.

![Visernic Toastr](./public/image/Image_j1pvfxj1pvfxj1pv.png)
...
To get started with Visernic Toastr, follow these steps:
...
```bash
composer require visernic/toastr
```
...
```bash
php artisan vendor:publish --tag=config --provider="Visernic\Toastr\ToastrServiceProvider"
```
...
```bash
php artisan vendor:publish --tag=toastr-assets --provider="Visernic\Toastr\ToastrServiceProvider"
```
...
<head>
    <!-- Include Toastr CSS -->
    <link rel="stylesheet" href="{{ asset('vendor/toastr/css/Visernic-toastr.min.css') }}">
</head>
<body>
    <!-- Your HTML content -->
    
    <!-- Include Toastr JavaScript -->
    <script src="{{ asset('vendor/toastr/js/visernic-toastr.min.js') }}"></script>
    @toastrRender
</body>
</html>
```
...
return [
    ...
    'options' => [
        ...
        'closeButtonIcon' => 'visernic-toast-close-icon',
        ...
        'positionClass' => 'visernic-toast-top-right',
        ...
        'icons' => [
            'info' => 'visernic-toast-info-icon',
            'warning' => 'visernic-toast-warning-icon',
            'success' => 'visernic-toast-success-icon',
            'error' => 'visernic-toast-error-icon',
        ],
        ...
        'colorsClasses' => [
            'info' => 'visernic-toast-info',
            'warning' => 'visernic-toast-warning',
            'success' => 'visernic-toast-success',
            'error' => 'visernic-toast-error',
        ],
    ],
